...
class chatbot(discord.Client):
    ...
    #             #     txt = msg.content
    #             #     txt = message.content
    #             #     continent, region = self.get_cont_region(self, txt)
    #             #     result = ["!DELETED!\n", continent, '\n', region]
    #             #     z = ''.join(result)
    #             #
        ...
        if '아르테미스' in txt:
            ...
            if '남부' in txt:
                ...
                if '크로나' in txt:
                    ...
                    region = '미상'
        elif '토토이크' in txt or '토토' in txt:
            continent = '토토이크'
            if '바다' in txt:
                region = '바다향기 숲'
            elif '달콤' in txt or '달숲' in txt:
                region = '달콤한 숲'
            elif '성큼' in txt:
                region = '성큼바위 숲'
            elif '침묵' in txt or '침거' in txt:
                region = '침묵하는 거인의 숲'
            else:
                region = '미상'
        elif '애니츠' in txt:
    ...
    #         return None
    #     else:
    #         if (after.channel.id == testID) or (after.channel.id == survID):
    #             result = []
    #
    #             bef_continent, bef_region = self.get_cont_region(self, before.content)
    #             bef_continent, bef_region = self.get_cont_region(self, before.content)
    #
